    ...
    <>
      ...
      <div className="flex justify-center items-center my-10 mb-20 mx-6 sm:mx-12 md:mx-20 lg:mx-32 xl:mx-48">
        ...
        >
          ...
          <button className="w-full bg-tertiary text-primary rounded-lg p-2 mt-4 hover:bg-orange-400 transition-all duration-300 hover:scale-105" onClick={() => router.push("/Booking")}>
            Agendar Nuevo Turno
          </button>
        </div>
      </div>
